...
- ssh into the server
    - For Mac and Linux: `ssh root@timbyers.dev`
    - For Windows: Set up a new PuTTY session
        ...
        - **Session**
            ...
            - Click Save
- create user
    - `useradd -m -s /bin/bash -g users -G sudo tbyers007`
    - replace tbyers007 with your own
- create password
    - `passwd tbyers007`
- Move .ssh key file
    - `cp -r .ssh /home/tbyers007`
- change ownership of the .ssh directory
    - `cd /home/tbyers007`
    - `chown -R tbyers007:users .ssh/`


- Test Changes
    - `exit`
    - Mac/Linux: `ssh tbyers007@timbyers.dev`
    - Windows:
        - **Session**
            - Click pwp
            - Click Load
...
- create a directory for your deployment
    - `sudo mkdir -p /var/www/timbyers.dev/html`
- fix permissions
    - `sudo chown -R $USER:users /var/www/timbyers.dev/html`
...
- `sudo vim /etc/nginx/sites-available/timbyers.dev`
...
server {
    ...
    root /var/www/timbyers.dev/html;
    index index.html index.htm index.nginx-debian.html;

    server_name timbyers.dev www.timbyers.dev;
...
- create a symlink to the sites-enabled directory
    - `sudo ln -s /etc/nginx/sites-available/timbyers.dev /etc/nginx/sites-enabled/`
...
- Create a new ssh key on your server in the .ssh directory
    - `ssh-keygen -t ed25519 -C  "github Deploy Key" -f /home/tbyers007/.ssh/github_deploy_key`
    - Don't enter a passphrase
        - hit enter twice
- Copy the public key into your authorized keys file
    - `cat /home/tbyers007/.ssh/github_deploy_key.pub >> /home/tbyers007/.ssh/authorized_keys`
...
- Copy the private key to your clipboard **(this is a very dangerous operation do not share this key with anyone )**
    ...
    - `cat /home/tbyers007/.ssh/github_deploy_key`
  ...
  deploy:
    ...
    steps:
      ...
      - name: Deploy to server
        run: |
         ssh-keyscan -H timbyers.dev >> ~/.ssh/known_hosts 
         scp -r ./dist/* tbyers007@timbyers.dev:/var/www/timbyers.dev/html
```
